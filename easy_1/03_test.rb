...
class OctalTest < Minitest::Test
  ...
  def test_octal_minus_7777_is_decimal_minus_4095
    assert_equal -4095, Octal.new('-7777').to_decimal
  end
...
# ..............................
#
# Finished in 0.035783s, 419.1939 runs/s, 419.1939 assertions/s.
#
# 15 runs, 15 assertions, 0 failures, 0 errors, 0 skips
# ]2;[Minitest results] 15 tests
#
#
# Finished in 0.504018s, 29.7609 runs/s, 29.7609 assertions/s.
# 15 runs, 15 assertions, 0 failures, 0 errors, 0 skips
